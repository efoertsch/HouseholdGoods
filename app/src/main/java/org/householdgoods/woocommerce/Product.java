...
//                .append("catalog_visibility", catalog_visibility)
                .append("description", description)
                .append("short_description", short_description).append("sku", sku)
//                .append("price", price)
                .append("regular_price", regular_price)
//                .append("sale_price", sale_price)
//                .append("date_on_sale_from", date_on_sale_from)
//                .append("date_on_sale_from_gmt", date_on_sale_from_gmt)
//                .append("date_on_sale_to", date_on_sale_to)
//                .append("date_on_sale_to_gmt", date_on_sale_to_gmt)
//                .append("price_html", price_html)
//                .append("on_sale", on_sale)
//                .append("purchasable", purchasable)
//                .append("total_sales", total_sales)
//                .append("virtual", virtual).append("downloadable", downloadable)
...
//                .append("tax_class", tax_class)
                .append("manage_stock", manage_stock)
                .append("stock_quantity", stock_quantity)
//                .append("stock_status", stock_status)
//                .append("backorders", backorders)
//                .append("backorders_allowed", backorders_allowed)
//                .append("backordered", backordered)
                .append("sold_individually", sold_individually)
//                .append("weight", weight)
                .append("dimensions", dimensions)
//                .append("shipping_required", shipping_required)
...
//                .append("related_ids", related_ids)
//                .append("upsell_ids", upsell_ids)
//                .append("cross_sell_ids", cross_sell_ids)
                 .append("parent_id", parent_id)
//                .append("purchase_note", purchase_note)
                .append("categories", categories).append("tags", tags)
