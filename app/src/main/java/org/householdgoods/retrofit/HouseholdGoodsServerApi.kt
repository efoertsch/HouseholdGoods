...
interface HouseholdGoodsServerApi {
    ...
    suspend fun getProductBySku(@Query("consumer_key") consumer_key: String
                                , @Query("consumer_secret") consumer_secret: String
                                , @Query("sku") sku: String): Product?
    ...
    fun getAllCategoriesTest(@Query("consumer_key") consumer_key: String, @Query("consumer_secret") consumer_secret: String, @Query("per_page") perPage: Int, @Query("offset") offset: Int): Call<List<Category>>
